    ...
    return (
        <>
            <div className="mt-[100px] w-full flex justify-center items-center lg:px-[120px] lg:py-[60px] sm:py-[60px] sm:px-[20px]">
                <div className="px-7 py-5 rounded-full h-[100px] max-[920px]:h-[70px] bg-[#131313] flex justify-between items-center w-full">
                    <h1 className="text-[#6e6e6e] text-[27px] ">Follow me</h1>
