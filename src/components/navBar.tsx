...
const NavBar = () => {
  ...
  const isActive = (href: string) => {
    ...
    return (
        <div className="flex w-full items-center justify-center top-5 fixed h-[60px]  ">
            <nav className=" flex px-8 py-3 inset-x-0 z-30 bg-[#211F23]/40 shadow backdrop-blur-lg md:top-6 md:rounded-3xl text-white gap-5">
