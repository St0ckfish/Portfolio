...
const Portfolio = () => {
    return (
        <div className="text-white grid w-full">
            ...
            <div className="bg-[url('/images/hero1.png')] py-5 bg-auto bg-fixed flex flex-wrap gap-10 w-full h-full justify-center px-[200px] max-[940px]:px-[1px]">
                ...
                <div className=" py-5 px-3 grid justify-center items-center rounded-2xl bg-gradient-to-t from-[#2d2833] via-[#3c2d4b] to-[#2a264e]">
                    ...
                    <div className="flex justify-between items-center mt-5 px-3">
                        ...
                        <Link href="https://github.com/seifsamehh/seifeldin" target="_blank" className="flex gap-2 items-center px-4 py-2 bg-sky-800 rounded-2xl hover:gap-3  duration-200">
