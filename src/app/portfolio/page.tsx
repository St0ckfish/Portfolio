            ...
            <div className=" py-5  flex flex-wrap gap-10 w-full h-full justify-center px-[200px] max-[940px]:px-[40px]">
                ...
                <motion.div
                    ...
                    <div className="flex flex-wrap px-3 py-4 gap-3">
                        <motion.div className="border border-[#1b1b1d] flex text-[#888889] gap-3 font-semibold justify-between rounded-full px-2 py-1 items-center text-[15px]" initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0, transition: { duration: 0.5, delay: 1 } }}>
                        ...
                        <motion.div className="border border-[#1b1b1d] flex text-[#888889] gap-3 font-semibold justify-between rounded-full px-2 py-1 items-center text-[15px]" initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0, transition: { duration: 0.5, delay: 1.2 } }}>
                            <Image src="/images/nxt.png" alt="#" className="rounded-md" width={20} height={20} />
                            <p>NextJS</p>
                        </motion.div>
                        <motion.div className="border border-[#1b1b1d] flex text-[#888889] gap-3 font-semibold justify-between rounded-full px-2 py-1 items-center text-[15px]" initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0, transition: { duration: 0.5, delay: 1.4 } }}>
